...
export const es = {
  ...
  lab: {
    ...
    steps: {
      optimize: "Optimiza",
      optimizeDesc: "Búsqueda aleatoria sobre el espacio del estudio",
      verdict: "Veredicto",
      verdictDesc: "Tu sesión frente a lo que hizo el estudio",
      compareDesc: "Todas las combinaciones que has probado, juntas",
      stepOf: "Paso {k} de {n}",
      next: "Siguiente",
      prev: "Anterior",
      needRun:
        "Este paso se llena con el resultado de un backtest. Diseña una configuración y ejecútala.",
      goDesign: "Ir a Diseña",
      noHistory:
        "Aún no has ejecutado ninguna combinación. Cada backtest y cada búsqueda quedan registrados aquí para compararlos con el mismo rasero.",
    },
    optimizer: {
      title: "Optimizador: búsqueda aleatoria",
      subtitle:
        "Muestrea N configuraciones del espacio de búsqueda del estudio, las puntúa in-sample como haría cualquier optimizador y enseña cuánto de esa puntuación sobrevive en la fase que no vio.",
      ...
      tileEvaluated: "Configuraciones evaluadas",
      tileBestIs: "Mejor Sharpe in-sample",
      tileBestOos: "Su Sharpe out-of-sample",
      tileNoise: "Sharpe máximo esperable por azar",
      noiseNote: "con {n} intentos sin ventaja",
      tileRho: "Correlación de rangos IS → OOS",
      scatterTitle: "In-sample frente a out-of-sample",
      scatterSubtitle:
        "Cada punto es una configuración. Si el ranking in-sample sirviera de algo, la nube subiría hacia la derecha.",
      xAxis: "Sharpe in-sample",
      yAxis: "Sharpe out-of-sample",
      winner: "Ganadora in-sample",
      tableTitle: "Las diez mejores in-sample",
      colRank: "#",
      colParams: "Parámetros",
      colIs: "Sharpe IS",
      colIsRet: "Retorno IS",
      colOos: "Sharpe OOS",
      colOosRet: "Retorno OOS",
      colDd: "Max DD OOS",
      colTrades: "Operaciones",
      load: "Cargar",
      note: "La ganadora in-sample es, por construcción, la cola derecha de N intentos: compárala con el Sharpe máximo que N configuraciones sin ventaja alcanzarían por puro azar. Si la correlación de rangos IS → OOS ronda cero, el ranking in-sample no dice nada del futuro. El paso Valida repite esta búsqueda pliegue a pliegue, con datos frescos cada vez: es lo que hizo el estudio.",
      overlaysNote:
        "La búsqueda evalúa la familia con sus parámetros y los costes del paso 1; los filtros y salidas del paso 1 no se aplican aquí.",
      empty: "Pulsa Buscar para muestrear el espacio del estudio.",
      stale:
        "Estos resultados son de la familia {family}; vuelve a buscar para la familia elegida ahora.",
    },
    verdict: {
      title: "Veredicto de la sesión",
      subtitle: "Lo que has probado, contado con el mismo rasero que el estudio.",
      attempts: "Backtests ejecutados en esta sesión",
      noise: "Sharpe máximo esperable por azar",
      noiseNote: "con ese número de intentos, sin ventaja alguna",
      bestOos: "Mejor Sharpe out-of-sample que has visto",
      none: "—",
      body: "Estas seis familias formaron parte de las trece que el estudio juzgó juntas: ninguna sobrevivió a la corrección por comparaciones múltiples y ninguna está promovida. Un buen número aquí es una invitación a repetir el paso Valida con semillas nuevas, no un descubrimiento.",
    },
    que: "¿Qué es esto?",
    queAnswer:
