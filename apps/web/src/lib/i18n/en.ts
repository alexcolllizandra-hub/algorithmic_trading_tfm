...
export const en = {
  ...
  lab: {
    ...
    steps: {
      optimize: "Optimise",
      optimizeDesc: "Random search over the study's space",
      verdict: "Verdict",
      verdictDesc: "Your session against what the study did",
      compareDesc: "Every combination you have tried, side by side",
      stepOf: "Step {k} of {n}",
      next: "Next",
      prev: "Previous",
      needRun: "This step fills with the result of a backtest. Design a configuration and run it.",
      goDesign: "Go to Design",
      noHistory:
        "You have not run any combination yet. Every backtest and every search is recorded here so they can be compared on the same footing.",
    },
    optimizer: {
      title: "Optimiser: random search",
      subtitle:
        "Samples N configurations from the study's search space, scores them in-sample the way any optimiser would, and shows how much of that score survives on the window it never saw.",
      ...
      tileEvaluated: "Configurations evaluated",
      tileBestIs: "Best in-sample Sharpe",
      tileBestOos: "Its out-of-sample Sharpe",
      tileNoise: "Max Sharpe expected by chance",
      noiseNote: "with {n} no-skill tries",
      tileRho: "Rank correlation IS → OOS",
      scatterTitle: "In-sample versus out-of-sample",
      scatterSubtitle:
        "Each point is one configuration. If the in-sample ranking meant anything, the cloud would rise to the right.",
      xAxis: "In-sample Sharpe",
      yAxis: "Out-of-sample Sharpe",
      winner: "In-sample winner",
      tableTitle: "Top ten in-sample",
      colRank: "#",
      colParams: "Parameters",
      colIs: "IS Sharpe",
      colIsRet: "IS return",
      colOos: "OOS Sharpe",
      colOosRet: "OOS return",
      colDd: "OOS max DD",
      colTrades: "Trades",
      load: "Load",
      note: "The in-sample winner is, by construction, the right tail of N tries: compare it with the maximum Sharpe that N no-skill configurations would reach by pure chance. If the IS → OOS rank correlation sits near zero, the in-sample ranking says nothing about the future. The Validate step repeats this search fold by fold, on fresh data every time: that is what the study did.",
      overlaysNote:
        "The search evaluates the family with its parameters and the costs from step 1; the filters and exits from step 1 are not applied here.",
      empty: "Press Search to sample the study's space.",
      stale:
        "These results belong to the {family} family; search again for the family selected now.",
    },
    verdict: {
      title: "Session verdict",
      subtitle: "What you tried, measured by the study's own yardstick.",
      attempts: "Backtests run in this session",
      noise: "Max Sharpe expected by chance",
      noiseNote: "with that many tries and no edge at all",
      bestOos: "Best out-of-sample Sharpe you have seen",
      none: "—",
      body: "These six families were among the thirteen the study judged together: none survived the multiple-comparisons correction and none is promoted. A good number here is an invitation to repeat the Validate step with fresh seeds, not a discovery.",
    },
    que: "What is this?",
    queAnswer:
