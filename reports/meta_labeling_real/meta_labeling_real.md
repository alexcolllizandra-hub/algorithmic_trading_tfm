...
|---|---:|---:|
| total net return | -0.3197 | +0.0088 |
| median Sharpe | -3.343 | +0.000 |

Folds improved: **4/4**. Abstention rate: **0.75**.

## Predictive skill

- ROC-AUC (median): **0.486**
- PR-AUC lift over base rate: **1.012**
- Brier score: 0.377
...
| 2 | 997 | 47 | 42 | no | +0.1441 | the filtered arm improved on the primary but still lost money on validation (net return -0 |
